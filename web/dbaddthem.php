<?php
    ...
    $DATANGUOIDUNG="INSERT INTO NGUOIDUNG (TENDANGNHAP,MATKHAU,HOTEN,DIACHI,SODT ,EMAIL,PHANLOAI)"."VALUES ('nguyenbaoadmin','123','NgVGB','123 abc','1234567890','abc@abc','admin')";
